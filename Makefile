...
run:
	...
	docker exec -t -i sponsorship_webapp_1 sh -c 'php /data/vendor/bin/doctrine-module orm:schema-tool:create'
	docker exec -t -i sponsorship_webapp_1 sh -c 'php /data/vendor/bin/cli cqrs:rebuild-projection -a'
